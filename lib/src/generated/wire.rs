...
pub struct BlindedAddressPublic {
...
pub struct BlindedAddressProof {
    ...
    pub ba_public: ::core::option::Option<BlindedAddressPublic>,
...
impl LicksSignatureScheme {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UninitializedLicksSignatureScheme => {
                "UNINITIALIZED_LICKS_SIGNATURE_SCHEME"
            }
            Self::HybridEd25519Falcon512 => {
                "LICKS_SIGNATURE_SCHEME_HYBRID_ED25519_FALCON512"
            }
            Self::OpenmlsEcdsaSecp256r1Sha256 => "OPENMLS_ECDSA_SECP256R1_SHA256",
            Self::OpenmlsEcdsaSecp384r1Sha384 => "OPENMLS_ECDSA_SECP384R1_SHA384",
            Self::OpenmlsEcdsaSecp521r1Sha512 => "OPENMLS_ECDSA_SECP521R1_SHA512",
            Self::OpenmlsEd25519 => "OPENMLS_ED25519",
            Self::OpenmlsEd448 => "OPENMLS_ED448",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod chat_service_message {
    ...
    pub struct SendMessageRequest {
        #[prost(message, optional, tag = "1")]
        pub proof: ::core::option::Option<super::BlindedAddressProof>,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
...
impl LicksApiError {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UninitializedLicksError => "UNINITIALIZED_LICKS_ERROR",
            Self::InvalidCredentials => "INVALID_CREDENTIALS",
            Self::InvalidOperation => "INVALID_OPERATION",
            Self::DecodeError => "DECODE_ERROR",
            Self::InternalError => "INTERNAL_ERROR",
            Self::ConnectionIsClosed => "CONNECTION_IS_CLOSED",
